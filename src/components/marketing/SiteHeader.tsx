    ...
    <header className="sticky top-0 z-10 border-b border-gray-200/70 bg-canvas/85 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-2 font-display font-semibold tracking-tight text-ink">
          <span
            aria-hidden
            className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-brand-700 text-xs text-white"
          >
            YP
          </span>
          YouArePilates
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Link
            href="/onboarding"
            className="rounded-lg bg-brand-700 px-4 py-2 font-semibold text-white shadow-sm hover:bg-brand-800"
          >
            Crear mi estudio
          </Link>
        </div>
